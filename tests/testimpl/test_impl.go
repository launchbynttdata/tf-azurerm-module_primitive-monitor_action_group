...
func TestComposableMonitorActionGroupModule(t *testing.T, ctx types.TestContext) {
	...
	t.Run("doesMonitorActionGroupExist", func(t *testing.T) {
		...
		MonitorActionGroupName := terraform.OutputContext(t, context.Background(), ctx.TerratestTerraformOptions(), "action_group_name")
